...
unsigned char SelectTecla;
char SelectContra[4];
char AlmContra[4] = {'1', '2', '3', '4'};
...
void Validacion_Contra() {
    ...
    switch (Estado_Teclado) {
        case N1:
            if ((SelectTecla != 0) && ((0 ? isdigit(SelectTecla) : ((unsigned)(SelectTecla)-'0') < 10))) {
                SelectContra[0] = SelectTecla;
                Estado_Teclado = N2;
                Lcd_Set_Cursor(2, 1);
                Lcd_Write_String("               ");
                Lcd_Set_Cursor(2, 8);
        ...
        case N4:
            ...
            break;
        case VAL:
            if ((SelectTecla != 0) && (SelectTecla != '=')) {
                Estado_Teclado = N1;
                Lcd_Set_Cursor(2, 9);
                Lcd_Write_String("               ");
                _delay((unsigned long)((600)*(8000000/4000.0)));
            } else if ((SelectTecla != 0) && (SelectTecla == '=')) {
